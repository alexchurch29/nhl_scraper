...
from espn_coordinates import scrape_date_range as espn_coordinates
...
def scrape_games_by_date(start_date, end_date):
    ...
    # add espn coordinates to pbp
    coords = espn_coordinates(start_date, end_date)
    pbp = pd.merge(left=pbp, right=coords, how='left', on=['Game_Id', 'Period', 'Time_Elapsed', 'Event_Type'])
